  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        Copyright © ${new Date().getFullYear()} Holo Janeway, USS_Shenzhou. Built with Docusaurus.
        ...
        </br>《Holo Janeway mod开发教程》使用<a href="https://holojaneway.uss-shenzhou.cn/holojaneway/0.1" target="_blank">CC BY-NC 4.0协议，BSD-3-Clause协议和GPLv3协议</a>授权。
