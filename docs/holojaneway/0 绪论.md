...
所以，但与其他教程可能略微不同的是，我包含了在开发《我的六号（Rainbow6:Minesiege）》（以下简称R6MS）、《灭 Extinguish》、《亮光 Brighter》、*T88*、《疯狂粒子 MadParticle》等模组时的经验总结。所以，不像通常的教程会教你写一个`foo`物品、`bar`方块，我更倾向于告诉你如何从无至有地写出破片手榴弹、消防水炮等等具体的物品、方块、实体或者其他的什么东西。
